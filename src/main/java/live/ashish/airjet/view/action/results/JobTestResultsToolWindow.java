...
package live.ashish.airjet.view.action.results;
...
public class JobTestResultsToolWindow {
    ...
    public void showMavenToolWindow() {
        ...
        try {
            consoleView = SMTestRunnerConnectionUtil.createAndAttachConsole(JobTestResultsToolWindowFactory.TOOL_WINDOW_ID, processHandler,
                    consoleProperties);
    ...
    private Optional<ToolWindow> getToolWindow() {
        ...
        return Optional.ofNullable(toolWindowManager.getToolWindow(JobTestResultsToolWindowFactory.TOOL_WINDOW_ID));
    }
